                ...
                if (tasks.length === 0) {
                    ...
                    badgesHtml = tasks.map(t => {
                        ...
                        if (isPastWeekly) {
                            ...
                            return `<div class="mini-badge" draggable="true" ondragstart="window.dragTaskStart(event, '${t.chapter.id}', '${dateStr}', ${badgeIsReview}, ${badgeReviewDay})" ondragover="event.preventDefault();" ondragenter="event.preventDefault();" ondrop="window.dropTask(event, '${dateStr}'); event.stopPropagation();" style="background: ${color}22; border: 1px solid ${color}44; display: flex; justify-content: space-between; align-items: center; padding: 4px 8px; cursor: grab; opacity: 0.55; filter: grayscale(20%);">
                            ...
                            return `<div class="mini-badge" style="background: ${color}22; color: ${color}; border: 1px solid ${color}44; cursor: grab; font-weight: 600;" draggable="true" ondragstart="window.dragTaskStart(event, '${t.chapter.id}', '${dateStr}', ${badgeIsReview}, ${badgeReviewDay})" ondragover="event.preventDefault();" ondragenter="event.preventDefault();" ondrop="window.dropTask(event, '${dateStr}'); event.stopPropagation();">
